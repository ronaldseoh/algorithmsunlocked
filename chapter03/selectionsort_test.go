...
func TestSelectionSort(t *testing.T) {
	...
	if testExpected0 != testArray[0] {
		t.Errorf("SelectionSort testArray[0]: Expected %q, Got %q", testExpected0, testArray[0])
	}

	if testExpected1 != testArray[1] {
		t.Errorf("SelectionSort testArray[1]: Expected %q, Got %q", testExpected1, testArray[1])
	}

	if testExpected2 != testArray[2] {
		t.Errorf("SelectionSort testArray[2]: Expected %q, Got %q", testExpected2, testArray[2])
	}

	if testExpected3 != testArray[3] {
		t.Errorf("SelectionSort testArray[3]: Expected %q, Got %q", testExpected3, testArray[3])
	}
}
